                      ...
                      <form class="" action="handle/handleTweet.php" method="post" enctype="multipart/form-data">
                        <div class="inner">
                          ...
                          <label>
                            ...
                            <textarea class="text-whathappen" name="status" rows="10" cols="100" placeholder="What's happening Today?"></textarea>
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <input id="tweet-input" type="submit" name="tweet" value="share" class="submit">
                          </div>
                      </div>
                      </form>
                    </div>
